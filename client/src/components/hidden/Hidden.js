    ...
    render(){
        return (
            ...
            <Jumbotron>
                ...
                <button className="btn btn btn-md" onClick={(e) => this.handleClick(e)}>FAQ's</button>
                <button
                    style={{
            ...
            <a className="drivewayPic" href="../../img/driveway.jpg" alt="driveway signs" height="650" width="1000"></a>
